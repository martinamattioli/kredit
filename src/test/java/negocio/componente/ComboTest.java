...
public class ComboTest {
    ...
    public static void init(){
        Producto primerProducto = new Producto("Samsung S21", "Celular de alta gama", 200,
                new Foto(), 0.4);
        Producto segundoProducto = new Producto("iPhone 12 Pro Max", "Celular de alta gama", 300,
                new Foto(), 0.2 );
        Producto tercerProducto = new Producto("Poco X3 Pro", "Celular de gama media", 150,
                new Foto(), 0.35);
    ...
    public void testElPrecioDelComboConOtroComboAdentroEsLaSumaDeAmbos(){
        Producto primerProducto = new Producto("Samsung S21", "Celular de alta gama", 1000,
                new Foto(), 0.4);
        Producto segundoProducto = new Producto("iPhone 12 Pro Max","Celular de alta gama", 350,
                new Foto(), 0.2);
