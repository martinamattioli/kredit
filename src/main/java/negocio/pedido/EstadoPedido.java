...
public abstract class EstadoPedido {
    ...
    public abstract void pagar(TarjetaDeCredito tarjetaDeCredito, Integer montoAPagar) throws MontoInsuficienteException, IOException, NoSePuedePagarException;
